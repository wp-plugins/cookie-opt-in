var cookie_opt_in = {
  ...
  checkboxes: function() {
    ...
    for (var j = 0; j < i; j ++) {
      ...
      if (typeof more_info_url !== 'undefined' && more_info_url !== '') {
        cookie_brief = cookie_brief + '<a href="'+ more_info_url + '" target="_blank" class="more">'+ cookie_opt_in_settings.more_info_text +'</a>';
      }
    ...
    if (typeof cookie_opt_in_settings.more_info_url !== 'undefined' && cookie_opt_in_settings.more_info_url !== '') {
      html = html + '<a href="'+ cookie_opt_in_settings.more_info_url + '" target="_blank" class="more generic-more">'+ cookie_opt_in_settings.more_info_text +'</a>';
    }
  ...
  init: function() {
    ...
    var html = '<div id="cookie_opt_in_container" style="display: none;"><form id="cookie_opt_in"><h1>' + cookie_opt_in_settings.form_title +'</h1>'+ cookie_opt_in.checkboxes();
      if (cookie_opt_in_settings.all_or_nothing == 1) {
  ...
  activate: function() {
    ...
    jQuery('#cookie_opt_in_container input.button').live('click', function(e) {
