        ...
        <tr>
          ...
          <td class="right">
            <input type="text" name="settings[more_info_url]" value="<?php print esc_attr($settings['more_info_url']); ?>" />
						<br />
						<input type="checkbox" name="settings[more_info_same_window]" value="yes" <?php if (isset($settings['more_info_same_window']) && $settings['more_info_same_window'] == "yes") { echo  "checked=\"checked\""; } ?> id="more_info_same_window" />
