...
class CookieOptIn {
  ...
  public static function admin_post() {
    ...
    if (wp_verify_nonce($_POST['is_cookie_opt_in'], 'is_cookie_opt_in')) {
      ...
      if (self::language('admin') != 'nl' && self::language('admin') != 'en') wp_die('asdasdasdad');
  ...
  public static function visitor_accepts($type) {
    $settings = self::settings();
    $cookie = isset($_COOKIE[ $settings['preference_cookie_name'] ]) ? $_COOKIE[ $settings['preference_cookie_name'] ] : '';
